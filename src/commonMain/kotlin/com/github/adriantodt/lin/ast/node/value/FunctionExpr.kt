...
public data class FunctionExpr(
    ...
    override fun <T> accept(visitor: NodeVisitor1<T>, param0: T) {
        visitor.visitFunctionExpr(this, param0)
    }
    /* @automation-end */

    public data class Parameter(val name: String, val varargs: Boolean, val defaultValue: Expr?)
}
