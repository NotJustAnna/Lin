...
data class SubscriptAssignNode(
    ...
    override fun accept(visitor: NodeMapVisitor): Node = visitor.visitSubscriptAssignNode(this)

    override fun <R> accept(visitor: NodeVisitorR<R>): R = visitor.visitSubscriptAssignNode(this)
